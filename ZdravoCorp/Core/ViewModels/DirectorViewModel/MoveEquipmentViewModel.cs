...
public class MoveEquipmentViewModel : ViewModelBase
{
    ...
    public MoveEquipmentViewModel(InventoryRepository inventoryRepository )
    {
        _lock = new object();
    ...
    private void MoveInventoryItem()
    {
        ...
        var transferWindow = new EquipmentTransferWindowView() { DataContext = new EquipmentTransferWindowViewModel(inventoryItemId) };
        transferWindow.Show();
