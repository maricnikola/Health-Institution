...
public class EquipmentPaneViewModel : ViewModelBase
{
    ...
    public void LoadComboBoxCollections()
    {
        ...
        EquipmentTypes.Add(Core.HospitalAssets.Equipment.Models.Equipment.EquipmentType.Room.ToString());
        EquipmentTypes.Add(Core.HospitalAssets.Equipment.Models.Equipment.EquipmentType.Examination.ToString());
        EquipmentTypes.Add(Core.HospitalAssets.Equipment.Models.Equipment.EquipmentType.Hallway.ToString());
        EquipmentTypes.Add(Core.HospitalAssets.Equipment.Models.Equipment.EquipmentType.Operation.ToString());
